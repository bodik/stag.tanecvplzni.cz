...
class Participant {
	...
	public function getPaymentReference() { return $this->paymentReference; }
	public function setPaymentReference($paymentReference) { $this->paymentReference = $paymentReference; return $this; }
