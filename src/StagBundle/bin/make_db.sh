...
mysql -NBe "insert into course (name,level,description,lecturer,place,pair,price_single,price_pair,color,appl_email_text,picture_ref_id) values ('SALSA 1', 'zacatecnici', '${TEXT2}', 'Strejda', 'Masala Ghar', 1, 100, 200, '#527dce', '${TEXT1}', 2)" $DATABASE
