...
mysql -NBe "insert into course (name,description,teacher,place,capacity,pair,price_single,price_pair) values ('kurz init 3', 'init db', 'make db', 'db', 4, 0, 500, 600)" stagtvp
...
COURSE_ID=$(mysql -NBe "select id from course where name='kurz init 3'" stagtvp)
